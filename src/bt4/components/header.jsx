...
function Header() {
  const activeClass = "block py-2 pr-4 pl-3 text-white rounded bg-blue-700 lg:bg-transparent lg:text-blue-700 lg:p-0 dark:text-white";
  const unactiveClass = "block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700";
    ...
    <header>
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <a href="/bt4/home" className="flex items-center space-x-3">
            <img
              src="https://flowbite.com/docs/images/logo.svg"
              className="h-8 sm:h-10"
              alt="Maxion Coffee Logo"
            />
          ...
          <div className="flex items-center lg:order-2 space-x-4">
            ...
            {/* Giỏ hàng */}
            <a href="/bt4/cart" className="relative flex items-center text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5">
              <div className="relative flex items-center justify-center">
                ...
                <span className="absolute top-[-5px] right-[-5px] flex items-center justify-center w-5 h-5 p-2 text-xs font-medium text-white bg-red-500 rounded-full">
                  {totalQuantity}
                </span>
              </div>
            </a>
